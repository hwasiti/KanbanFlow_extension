...
- A touch-friendly **+↑** button on task cards in Firefox for Android and other touch browsers.
...
dist/chrome/
dist/firefox/
releases/kanbanflow-insert-above-chrome-1.2.0.zip
releases/kanbanflow-insert-above-firefox-1.2.0.zip
```
...
9. Open task details, open a subtask's three-dot menu, and choose **Add subtask above**.
10. Enter a temporary subtask, press Enter, and confirm it moves immediately above the selected subtask.
...
9. Tap **+↑** on a task card, create a temporary task, and verify its position.
10. Open task details, tap a subtask's three-dot menu, choose **Add subtask above**, create a temporary subtask, and verify its position.
...
Version 1.2.0 passes with zero errors, warnings, or notices.
...
7. Upload `releases/kanbanflow-insert-above-chrome-1.2.0.zip`.
...
6. Upload `releases/kanbanflow-insert-above-firefox-1.2.0.zip`.
...
4. Open task details, open a subtask's three-dot menu, choose “Add subtask above,” and confirm the new subtask's position.

Firefox Android test:
1. Sign in and open the board URL.
2. Tap the +↑ button on a task card and create a temporary task.
3. Open task details and use “Add subtask above” from a subtask's three-dot menu.
...
5. Commit the release and optionally create a Git tag such as `v1.2.0`.
